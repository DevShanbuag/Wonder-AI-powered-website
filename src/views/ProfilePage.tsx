...
export default function ProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-background pb-24 md:pb-8">
      {/* Header */}
      <header className="sticky top-0 z-10 bg-background/80 backdrop-blur-sm border-b border-border px-6 py-5 flex items-center justify-between shadow-sm">
          ...
          {menuItems.map((item, index) => (
            item.isLogout ? (
              <button
                ...
                className={`w-full text-left flex items-center justify-between p-4 hover:bg-accent transition-colors ${
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-50 bg-background border-t border-border px-6 py-3 flex items-center justify-between md:hidden">
